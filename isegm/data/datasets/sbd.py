...
from isegm.data.my_base import ISDataset
...
class SBDDataset(ISDataset):
    ...
    def get_sample(self, index):
        ...
        return DSample(image_name, image, instances_mask, objects_ids=instances_ids, sample_id=index)
...
class SBDEvaluationDataset(ISDataset):
    ...
    def get_sample(self, index) -> DSample:
        ...
        return DSample(image_name, image, instances_mask, objects_ids=[1], sample_id=index)
